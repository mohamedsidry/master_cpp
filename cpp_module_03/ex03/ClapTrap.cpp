...
/*   Updated: 2026/01/28 15:09:47 by msidry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief ClapTrap: Custom constructor that takes a name .
 * @details: set attributes to default and name to name .
 * @param [in] name  name .
 * @param [in] hp hit points .
 * @param [in] ep energy point .
 * @param [in]  ep attack damage! .
 * @return nothing !
*/
...
attackDamage(ad)
{
    std::cout << "ClapTraper " << "Custom constructor was called !" << std::endl;
}
