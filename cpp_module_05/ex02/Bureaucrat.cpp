...
/**
 * @brief Bureaucrat::signForm try to sign the form and display message .
 * @param [in] ref reference to form to be signed .
*/
...
/**
 * @brief Bureaucrat::signForm try to execute the form and display message .
 * @param [in] ref reference to form to be signed .
*/
